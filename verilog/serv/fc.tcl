...
analyze -format verilog consolidated.v
elaborate serv_top
set_top_module serv_top
...
create_mode max; create_corner max; create_scenario -name max_max -mode max -corner max
  ...
  create_clock -period 10.0 -name clk [get_port clk];
...
write_verilog -split_bus -hierarchy all -exclude { pg_objects unconnected_ports } final.v
